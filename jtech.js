...
function appendData(data) {
    ...
    const states = [];
    mainContainer.innerHTML = '<li class="nav-item" role="presentation" hidden><button class="nav-link" id="pills-default-tab" data-bs-toggle="pill" data-bs-target="#pills-default" type="button" role="tab" aria-controls="pills-default" aria-selected="false"></button></li>';
